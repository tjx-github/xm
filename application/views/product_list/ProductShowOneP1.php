...
<body>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">美工--编辑产品</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
                ...
                <div class="col-lg-12">
                    ...
                    <div class="form-group form-inline">
                                ...
                                <select  id="saletype" class="form-control">
                                    ...
                                    <option value="寄售" <?php if($product['saletype']=='寄售'){echo 'selected';}?> disabled>寄售</option>  
                                  </select>
                    </div>
...
<script src="<?php echo site_url('/')?>bootadmin/layer2/layer.js"></script>
 ...
 $('#gobtn').on('click',function(){
    ...
    $("#uploader img").each(function(i){
               ...
               inputstr+='<input name="img[]" type="hidden" value="'+$(this).attr("src")+'">';
//               inputstr+='<input name="img[]" type="file" class=\'xf\'  value="'+$(this).attr("src")+'">';
