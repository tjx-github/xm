...
<!-- Generic page styles -->
<link rel="stylesheet" href="/bootadmin/j/css/style.css">
<!-- blueimp Gallery styles -->
<!--<link rel="stylesheet" href="http://blueimp.github.io/Gallery/css/blueimp-gallery.min.css">-->
<!-- CSS to style the file input field as button and adjust the Bootstrap progress bars -->
<link rel="stylesheet" href="/bootadmin/j/css/jquery.fileupload.css">
<link rel="stylesheet" href="/bootadmin/j/css/jquery.fileupload-ui.css">
<!-- CSS adjustments for browsers with JavaScript disabled -->
<noscript><link rel="stylesheet" href="/bootadmin/j/css/jquery.fileupload-noscript.css"></noscript>
<noscript><link rel="stylesheet" href="/bootadmin/j/css/jquery.fileupload-ui-noscript.css"></noscript>
    ...
    <link href="/static/css/bearadmin.css" rel="stylesheet">
</head>
                ...
                <div class="col-lg-12">
                                ...
                                <div class="col-lg-6">
                                    <form role="form" id="addform" method="post" action="">
                                        ...
                                        <div class="form-group form-inline" id="piddiv">
                                            ...
                                            <input class="form-control" name="pid" id="pid" value="<?php echo $product['pid']?>"   placeholder="请输入货号" disabled>
                    ...
                    <div class="form-group form-inline">
                                <label class="col-md-2">所属仓库：</label>
                                  ...
                                  <?php 
                                    foreach ($search['store'] as $key => $value) {
                    ...
                    <div class="form-group form-inline" id="piddiv">
                       ...
                       <div class="form-group form-inline">
                                ...
                                <select name="status" id="status" class="form-control">
                                  ...
                                  <?php 
                                    foreach ($search['product_status'] as $key => $value) {
                      ...
                      <div class="form-group form-inline">
                               ...
                               <select name="cityid" id="cityid" class="form-control">
                                  ...
                                  <?php 
                                    foreach ($search['city'] as $key => $value) {
...
<!--                    <div class="form-group form-inline">
                           ...
                           <div class="form-group form-inline">
                                ...
                                <select name="payment" id="payment" class="form-control">
                                    <option value="">付款方式：</option>
                                     <?php 
                                      foreach ($search['sale_payment'] as $key => $value) {
              ...
              <div class="form-group form-inline" id="codediv">
                                    <label class="col-md-2">是否拍视频</label>
                                    <?php 
                                    if($product['video']){
               ...
               <div class="form-group" id="codediv">
                        ...
                        <div class="form-group" id="codediv">
                                        <label class="col-md-2">视频地址：</label>
                                       <?php 
                                        if(empty($product['video']) || $product['video'] == 1 ){
                                            echo "没有视频";
                                        }else{
 ...
 <div class="form-group" id="updiv">
        <label class="col-md-12">更换图片（如果新上传图片，会覆盖以前的）</label>                                     
...
<script src="/bootadmin/j/js/vendor/jquery.ui.widget.js"></script>
...
<script src="/bootadmin/j/js/jquery.iframe-transport.js"></script>
<!-- The basic File Upload plugin -->
<script src="/bootadmin/j/js/jquery.fileupload.js"></script>
<!-- The File Upload processing plugin -->
<script src="/bootadmin/j/js/jquery.fileupload-process.js"></script>
<!-- The File Upload image preview & resize plugin -->
<script src="/bootadmin/j/js/jquery.fileupload-image.js"></script>
<!-- The File Upload audio preview plugin -->
<script src="/bootadmin/j/js/jquery.fileupload-audio.js"></script>
<!-- The File Upload video preview plugin -->
<script src="/bootadmin/j/js/jquery.fileupload-video.js"></script>
<!-- The File Upload validation plugin -->
<script src="/bootadmin/j/js/jquery.fileupload-validate.js"></script>
<!-- The File Upload user interface plugin -->
<script src="/bootadmin/j/js/jquery.fileupload-ui.js"></script>
<!-- The main application script -->
<script src="/bootadmin/j/js/main.js"></script>
 ...
 $('#gobtn').on('click',function(){
    ...
    $piclist.html(inputstr);
     ...
     if($('#pid').val()=='')
      ...
      $.post("/home/TProductEditUpdate/",$("form").serializeArray(),function(data){
            layer.open({
                title: '信息', 
                time:1000,
                anim:1,
