                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-lg-6">
                                    <form role="form" id="addform" method="post" action="<?php echo site_url('home/user_resetpass_save')?>">
                                        <input type="hidden" name="id" value="<?php echo $user['id']?>">
                                          <div class="form-group form-inline" id="codediv">
                                            <label>用户名：</label>
                                            <input class="form-control"  style="width:300px;"  name="username" disabled id="username" value="<?php echo $user['username']?>" placeholder="客户姓名">
                                        </div>
