                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-lg-6">
                                    <form role="form" id="addform" method="post" action="<?php echo site_url('home/customer_edit_save')?>">
                                        <input type="hidden" name="id" value="<?php echo $customer['id']?>">
                                          <div class="form-group form-inline" id="codediv">
                                            <label>客户姓名：</label>
                                            <input class="form-control"  style="width:300px;"  name="fullname"  id="fullname" value="<?php echo $customer['fullname']?>" placeholder="客户姓名">
                                        </div>

                                        <div class="form-group form-inline" id="piddiv">
                                            <label>客户编号：</label>
                                            <input class="form-control" name="cid" id="cid" disabled placeholder="输入客户编号" value="<?php echo $customer['cid']?>">
                               ...
                               <div class="form-group form-inline" id="codediv">
                                        <label>微信昵称：</label>
                                        <input class="form-control" name="weixinname"  id="weixinname" value="<?php echo $customer['weixinname']?>"  placeholder="微信名">
                                </div> 

                                <div class="form-group form-inline" id="codediv">
                                        <label>微 信 号：</label>
                                        <input class="form-control" name="weixinid"  id="weixinid" value="<?php echo $customer['weixinid']?>"  placeholder="微信号">
                                </div> 

                                <div class="form-group form-inline" id="codediv">
                                        <label>手机号码：</label>
                                        <input class="form-control" name="mobile"  id="mobile"  value="<?php echo $customer['mobile']?>" placeholder="手机号码">
                                </div>   
 
                <div class="form-group form-inline" id="codediv">
                                        <label>收货地址：</label>
                                        <input class="form-control" style="width:300px;"   name="address"  id="address"  value="<?php echo $customer['address']?>" placeholder="收货地址">
                                </div>   
 
                <div class="form-group form-inline" id="codediv">
                                           <label>付款账号：</label>
                                            <input class="form-control"  style="width:300px;"  name="payaccount"  id="payaccount" value="<?php echo $customer['payaccount']?>" placeholder="付款账号">
                                        </div>
                      <div class="form-group" id="codediv">
                                           <label>个人特征：(身高，体重，尺码等信息)</label>
                                            <input class="form-control"    name="personal"  id="personal" value="<?php echo $customer['personal']?>" placeholder="身高，体重，尺码等信息">
                                        </div>

              <div class="form-group" id="codediv">
                                           <label>家庭情况：</label>
                                            <input class="form-control"   name="family"  id="family" value="<?php echo $customer['family']?>" placeholder="家庭情况">
                                        </div>

                            <div class="form-group" id="codediv">
                                           <label>职业信息：</label>
                                            <input class="form-control"   name="career"  id="career" value="<?php echo $customer['career']?>" placeholder="职业信息">
                                        </div>
                         ...
                         <div class="form-group" id="codediv">
                                        <label>交易信息：</label>
                                       <textarea class="form-control" name="tradeinfo" id="tradeinfo" rows="3"><?php echo $customer['tradeinfo']?></textarea>
                       </div>


                  <div class="form-group" id="codediv">
                                        <label>备注信息：</label>
                                       <textarea class="form-control" name="content" id="content" rows="3"><?php echo $customer['content']?></textarea>
                       </div>
                          ...
                          <option value="">来源渠道</option>
                             <?php 
                                        foreach ($saleman as $key => $value) {
                                          if($customer['channel']==$value['name'])
                                            {
