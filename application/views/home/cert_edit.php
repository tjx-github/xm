...
<body>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">修改鉴定证书</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-lg-6">
                                    <form role="form" id="addform" method="post" action="<?php echo site_url('home/cert_edit_save')?>">
                                        <input type="hidden" name="id" value="<?php echo $cert['id']?>"> 
                                        <div class="form-group" id="piddiv">
                                            <label>货号</label>
                                            <input class="form-control" name="pid" id="pid" placeholder="请输入货号" value="<?php echo $cert['pid']?>">
                                             
                                        </div>
                                        <div class="form-group" id="codediv">
                                            <label>证书编号</label>
                                            <input class="form-control" name="code"  id="code" placeholder="输入证书编号" value="<?php echo $cert['code']?>">
                                        </div>
                       ...
                       <div class="form-group"   id="otherdiv">
                                    <label>品牌</label>
                                    <input class="form-control" placeholder="品牌" name="brandname" id="brandname" value="<?php echo $cert['brandname']?>">
                            </div>
                      ...
                      <div class="form-group" id="codediv">
                                        <label>款式</label>
                                        <input class="form-control" name="style"  id="style" placeholder="款式" value="<?php echo $cert['style']?>"> 
                                    </div>
<!--
                             <div class="form-group" id="codediv">
                                        <label>材质</label>
...
-->
      ...
      <div class="form-group form-inline" id="codediv">
                                    <label>封面照片</label>
                                      <img src="<?php echo $cert['facephoto']?>" id="myimg" height="120" width="120"  ><br>
     ...
     <div class="form-group" id="photosdiv">
       ...
       <div >
 <?php 
 if(strlen($cert['photos'])>5){
                                             $picarr=json_decode($cert['photos']);
