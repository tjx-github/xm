...
<body>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                         ...
                                         <td class="imglist" id="<?php echo $value->id;?>">
                                             ...
                                             <th><a href="http://wx.uzhengpin.com/cert/certview?code=<?php echo $value->code?>" target="_blank">预览</a>&nbsp;<a href="<?php echo site_url('home/cert_edit/'.$value->id)?>">编辑</a> &nbsp;<a href="http://www.baidu.com" data-toggle="modal" data-target="#myModal" class="delbtn" value="<?php echo $value->id?>" onclick="getid(<?php echo $value->id?>)">删除</a></th>
                                        </tr>
                                        <?php } ?>
 ...
 <div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    ...
    $('#delok').on('click',function(){
        //alert($('#myid').val());
        window.location='<?php echo site_url("home/cert_del")?>/'+$('#myid').val();
    });
