...
<body>
 ...
 <div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    ...
    $('#delok').on('click',function(){
        //alert($('#myid').val());
        window.location='<?php echo site_url("home/admin_del")?>/'+$('#myid').val();
    });
        

    $('#searchbtn').on('click',function(){
        wd=$('#wd').val();
        window.location='<?php echo site_url("home/admin_list/1")?>/'+wd;
       // alert($('#wd').val());
    });  
 ...
 $('#searchbtn').on('click',function(){
        ...
        window.location='<?php echo site_url("home/admin_list/1")?>/'+query;
       // alert($('#wd').val());
    });  
