...
<body>
                                ...
                                <table class="table  table-bordered table-hover">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <?php if($value['id']<>2){?>
                                                <a href="http://www.baidu.com" data-toggle="modal" data-target="#myModal" class="delbtn btn btn-danger" value="<?php echo $value['id']?>" onclick="getid(<?php echo $value['id']?>)">删除</a>
                                            <?php }?>
                                            </th>
                                            </form>
                                        </tr>
                                        <?php } ?>
                                        <tr>
                                            <form name="addform" method="post" action="<?php echo site_url('home/store_add_save')?>">
                                            <td>增加记录</td>
                                             
                                            <td> <input name="name" type="text"  ></td>
                                             <td></td>
                                            <td><input name="ordernum" type="text"  value="<?php echo count($store) + 1 ; ?>"> </td>
 ...
 <div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    ...
    $('#delok').on('click',function(){
        //alert($('#myid').val());
        window.location='<?php echo site_url("home/store_del")?>/'+$('#myid').val();
    });
