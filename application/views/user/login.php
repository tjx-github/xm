            ...
            <div class="col-md-4 col-md-offset-4">
                ...
                <div class="login-panel panel panel-default">
                    <div class="panel-heading">
                        <h3 class="panel-title"><?php echo SITENAME?></h3>
                    </div>
                    <div class="panel-body">

                        <div class="alert alert-danger alert-dismissable" id="errmsg" style="display:none">
                        ...
                        <form role="form">
                            <fieldset>
                                <div class="form-group">
                                    <input class="form-control" placeholder="用户名" name="username"  id="username" type="test" autofocus>
                                </div>
                                <div class="form-group">
                                    <input class="form-control" placeholder="密码" name="password"  id="password" type="password" value="1">
                                </div>
                                <div class="checkbox">
                                    <label>
                                        <input name="remember" type="checkbox" value="Remember Me">记住我的登录
                                    </label>
                                </div>
                                <!-- Change this to a button or input when using this as a form -->
                                <a href="#" class="btn btn-lg btn-success btn-block" id="loginbtn">登录</a>
                            </fieldset>
                        </form>
                    </div>
                </div>
    ...
    $(function(){
        ...
        $('#loginbtn').on('click',function(){
               ...
               var password=$('#password').val();
                ...
                $.post('/user/checklogin', { username:username,password:password}, function(response){
