...
<body>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">销售平台管理</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
                            ...
                            <div class="table-responsive">
                                <table class="table  table-bordered table-hover">
                                    ...
                                    <tbody>
                                        ...
                                        ?>
                                        <tr>
                                            <form name="saveform<?php echo $value['id']?>" method="post" action="<?php echo site_url('home/sale_platform_edit_save')?>">
                                        ...
                                        <?php } ?>
                                        <tr>
                                            <form name="addform" method="post" action="<?php echo site_url('home/sale_platform_add_save')?>">
                                            <td>增加记录</td>
                                            <td> <input name="name" type="text"  ></td>
                                            <td><input name="ordernum" type="text"  value="<?php echo  count($platform) +1; ?>"> </td>
 ...
 <div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    ...
    $('#delok').on('click',function(){
        //alert($('#myid').val());
        window.location='<?php echo site_url("home/sale_platform_del")?>/'+$('#myid').val();
    });
